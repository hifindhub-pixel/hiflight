  ...
  return (
    <footer className="site-footer">
      <div className="footer-grid">
        ...
        <div><strong>Comparer</strong><Link href="/#recherche">Vols</Link><Link href="/hotels">Hôtels</Link><Link href="/voitures">Voitures</Link><Link href="/trains-bus">Trains & bus</Link><Link href="/esim">eSIM</Link></div>
