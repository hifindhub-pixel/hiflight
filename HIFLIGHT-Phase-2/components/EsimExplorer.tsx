...
export default function EsimExplorer() {
  ...
  return (
    <>
      <section className="market-hero esim"><div><p className="eyebrow">eSIM de voyage</p><h1>Le monde dans votre poche,<br /><span>dès l’atterrissage.</span></h1><p className="esim-hero-copy">Comparez les forfaits de plusieurs spécialistes et gardez votre numéro tout en voyageant connecté.</p><form className="esim-search" onSubmit={submit}>
