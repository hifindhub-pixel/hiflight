  ...
  return (
    <main className={styles.page}>
      <div className={styles.shell}>
        ...
        <a className={styles.inspirationCard} href="https://blog.hiflight.fr"><img src="/account-landscape-v2.webp" alt="Lac et montagnes baignés de lumière" /><div><span>VOYAGER AUTREMENT</span><h2>De belles découvertes,<br />avec plus de sens.</h2><p>Conseils, inspirations et nouvelles façons d’imaginer vos prochains départs.</p><strong>Découvrir le blog <ArrowRight size={17} /></strong></div></a>
      </div>
