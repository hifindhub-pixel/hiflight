    ...
    <main>
      <section className="hero">
        <div className="hero-inner">
          <div className="hero-copy"><h1>Comparez les vols.<br /><span>Voyagez au juste prix.</span></h1><p>Des centaines de compagnies et agences comparées gratuitement, sans inscription.</p></div>
          <SearchForm />
