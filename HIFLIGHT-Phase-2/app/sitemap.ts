...
export default function sitemap(): MetadataRoute.Sitemap {
  const staticPages = ["", "/hotels", "/voitures", "/trains-bus", "/esim", "/world-map", "/blog", "/faq", "/conditions-utilisations", "/guides/bagage-cabine", "/mentions-legales", "/politique-de-confidentialite"];
  return [
