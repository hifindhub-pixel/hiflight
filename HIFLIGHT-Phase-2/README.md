...
- Informations juridiques dans `app/mentions-legales/page.tsx`.
- Politique de confidentialité selon les outils réellement activés.
- Identifiant GA4.
- Vérification juridique du consentement et des textes.
- Paramétrage du sous-domaine Travelpayouts.

## Limite actuelle

Le clic final vers une compagnie ou une agence se produit dans le white-label Travelpayouts. Il doit être rapproché des événements HIFLIGHT à l’aide des statistiques Travelpayouts et des marqueurs de campagne. Le lot suivant pourra ajouter les alertes de prix et les favoris avec une base de données.
