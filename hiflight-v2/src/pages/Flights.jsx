    ...
    <div className="fp">
          ...
          <div className="fp-search">
            <form onSubmit={handleSearch}>
              ...
              <div className="fp-fields-row">
                <div className="fp-field-wrap fp-field-wrap--lg">
                ...
                <div className="fp-vsep" />
                <div className="fp-field-wrap fp-field-pax">
                  <span className="fp-pax-label">{adults} passager{adults > 1 ? 's' : ''}</span>
                  <span className="fp-pax-sub">économie</span>
                  <select className="fp-pax-select" value={adults} onChange={e=>setAdults(Number(e.target.value))}>
                    {[1,2,3,4,5,6].map(n => <option key={n} value={n}>{n} passager{n>1?'s':''}</option>)}
                  </select>
                </div>
                <button type="submit" className="fp-btn-search" disabled={loading}>
      ...
      {loading && (
        <div className="fp-loading">
          <div className="fp-spin fp-spin--lg" />
              ...
              {POPULAR.map(p => (
                <div key={p.code} className="fp-pop-card" onClick={() => selectPopular(p)}>
                  <div className="fp-pop-img">
                    ...
                    <div className="fp-pop-label-wrap">
